/*
Ejercicio 5: Leer por teclado dos tablas de 10 numeros enteros y mezclarlas
en una tercera de la forma: El primero del A, el primero del B, el segundo
del A, el segundo del B, etc.
*/
...
public class Arreglos_Ejercicio_5 {
    public static void main(String[] args) {
        ...
        System.out.println("Llenamos el tercer arreglo: ");
        for (int i = 0; i < 20; i++) {
